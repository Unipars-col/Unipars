...
export default function AdminPage() {
  ...
  const firstName = userName.split(" ")[0] || "Proveedor";
      ...
      {activeTab === null ? (
        <section className="mx-auto max-w-[1440px] px-6 py-10 lg:py-14">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-7 text-[#6e7379]">
              Gestiona tu catalogo, inventario y pedidos desde un solo lugar.
            </p>
          </div>
                ...
                {[
                  {
                    ...
                    desc: "Publica nuevos productos en tu catálogo.",
                    iconBg: "bg-[#fff6ee]",
                    icon: (
                  ...
                  },
                  {
                    ...
                    desc: "Actualiza y administra tus productos.",
                    iconBg: "bg-[#fff6ee]",
                    icon: (
                  ...
                  {
                    label: "Inventario",
                    desc: "Gestiona tu stock y disponibilidad.",
                    iconBg: "bg-[#f0fdf4]",
                    icon: (
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-black/8 bg-white p-6 shadow-sm">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#fff6ee]">
                  <svg aria-hidden="true" viewBox="0 0 24 24" className="h-6 w-6 text-[#ed8435]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div>
                  <h3 className="font-bold text-[#16384f]">Quieres vender mas?</h3>
                  <p className="mt-1 text-sm leading-6 text-[#6e7379]">Completa tu catalogo y manten el inventario actualizado para aparecer en mas busquedas.</p>
                </div>
              </div>
              <button type="button" onClick={openCreateView} className="shrink-0 rounded-full bg-[#ed8435] px-6 py-2.5 text-sm font-semibold text-white hover:bg-[#d67024]">
                Mejorar mi catalogo
              </button>
            </div>
            <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-black/8 bg-white p-6 shadow-sm">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#f0f4ff]">
                  <svg aria-hidden="true" viewBox="0 0 24 24" className="h-6 w-6 text-[#6366f1]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="12" cy="12" r="10" /><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" /><path d="M12 17h.01" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-bold text-[#16384f]">Necesitas ayuda?</h3>
                  <p className="mt-1 text-sm leading-6 text-[#6e7379]">Visita nuestro centro de ayuda o contactanos.</p>
                </div>
              </div>
              <a href="/ayuda" className="shrink-0 rounded-full border border-[#16384f]/30 px-6 py-2.5 text-sm font-semibold text-[#16384f] hover:border-[#16384f]/60 hover:bg-[#16384f]/5">
                Ir a ayuda
              </a>
            </div>
          </div>
