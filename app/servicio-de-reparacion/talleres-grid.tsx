        ...
        {talleres.map((taller) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col px-4 pb-4 pt-8">
              ...
              <p className="text-xs text-gray-400">({taller.reviews} reseñas)</p>

              {/* Aliado badge */}
              <p className="mt-1.5 flex items-center gap-1 text-xs font-semibold text-[#ed8435]">
              ...
              {/* Servicios chips — altura fija para alinear tarjetas */}
              ...
              <div className="mt-3 flex items-center justify-between text-xs">
                <span className="flex items-center gap-1 text-gray-500">
                  <svg viewBox="0 0 16 16" className="h-3.5 w-3.5 flex-shrink-0" fill="currentColor">
              ...
              <div className="mt-3 flex gap-3 border-t border-gray-100 pt-3">
                <div className="flex flex-1 items-center gap-1.5 text-xs text-gray-500">
                  <svg viewBox="0 0 20 20" className="h-4 w-4 text-[#ed8435]" fill="currentColor">
                  ...
                  <div>
                    ...
                    <p className="text-[10px]">de experiencia</p>
                  </div>
                </div>
                <div className="flex flex-1 items-center gap-1.5 text-xs text-gray-500">
                  <svg viewBox="0 0 20 20" className="h-4 w-4 text-[#ed8435]" fill="currentColor">
                  ...
                  <div>
                    ...
                    <p className="text-[10px]">clientes atendidos</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 flex gap-2">
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-gray-200 py-2.5 text-xs font-semibold text-[#16384f] transition-colors hover:border-[#16384f] hover:bg-[#16384f] hover:text-white"
                >
                ...
                <a
                  ...
                  target="_blank" rel="noopener noreferrer"
                  className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-[#16384f] py-2.5 text-xs font-semibold text-white transition-opacity hover:opacity-90"
                >
